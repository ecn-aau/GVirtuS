...
using gvirtus::communicators::Endpoint_Quic;
using gvirtus::communicators::EndpointFactory;

Endpoint_Quic::Endpoint_Quic(const std::string &endp_suite,
...
Endpoint &Endpoint_Quic::suite(const std::string &suite) {
...
Endpoint &Endpoint_Quic::protocol(const std::string &protocol) {
...
Endpoint_Quic &Endpoint_Quic::address(const std::string &address) {
  std::regex pattern{
...
Endpoint_Quic &Endpoint_Quic::port(const std::string &port) {
  std::regex pattern{
...
void gvirtus::communicators::from_json(const nlohmann::json &j, Endpoint_Quic &end) {
